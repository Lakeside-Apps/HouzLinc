...
public class ModelTestsBase
{
    ...
    private protected House remoteHouse = null!;
    ...
    {
        // Play the changes recorded while modifying model house against yet unmodified remoteHouse
        ...
        await ModelHolderForTest.SaveToFile("Changes", TestContext.TestName!, remoteHouse);
    ...
    private protected async Task PlayMergeAndCheck()
    {
        ...
        await ModelHolderForTest.SaveToFile("Merges\\beforeCopy", TestContext.TestName!, remoteHouse);

        // Now apply (copy) the merged model back on our working model (house)
        house.CopyFrom(remoteHouse);
